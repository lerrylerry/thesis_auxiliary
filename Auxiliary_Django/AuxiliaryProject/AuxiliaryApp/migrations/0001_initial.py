    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userType', models.CharField(choices=[('ADMIN', 'ADMIN'), ('UTILITY_PERSONNEL', 'UTILITY_PERSONNEL'), ('RERAIR_MAN', 'REPAIR_MAN'), ('ASSISTANT_DIRECTOR', 'ASSISTANT_DIRECTOR')], max_length=100, verbose_name='userType')),
